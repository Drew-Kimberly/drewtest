...
<?php /*kpr(get_defined_vars()); */?>
   ...
   <!-- header starts-->
    ...
    <div id="content-wrapper" class="container_16">
      ...
      <?php if ($breadcrumb): ?>
        <div id="breadcrumb" class="grind_16"><?php print $breadcrumb; ?></div>
      <?php endif; ?>
    ...
    <div id="footer-wrapper" class="container_16">
      ...
      <div id="footer-bottom">
        ...
        <ul class="links secondary-links">
          <li><a href="../../../../DrupalSites/acquia-drupal/sites/all/themes/ninesixtyrobots/index.html" title="" class="active">Home</a></li>
