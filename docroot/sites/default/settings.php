 ...
 * @endcode
 */
$settings['hash_salt'] = 'vRdmSUDdTKzThTxAxgQASKt-tbf_LbdaYtKL8AGs8c0Rax2e8SZyMJfBb_pX7289Dk-etOlecg';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal8site_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal8site_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
